<template>
  <div class="fen">
    <van-nav-bar title="粉丝" left-text="返回" fixed left-arrow @click-left="onClickLeft">
...
export default {
  ...
  created() {
    ...
    axios({
      type: 'get',
      url: `http://172.16.1.233:3000/user/followeds?uid=${id}`,
    }).then((res) => {
  ...
  methods: {
    ...
    favor(index) {
      ...
      const domBtn = document.querySelectorAll('button')[index];
